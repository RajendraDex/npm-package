...
router.post('/create',verifyRolePermissions,sanitizeMiddleware, validateMiddleware(createRoleSchema),RoleController.createRole);
...
router.get('/list',  verifyRolePermissions, RoleController.getRoles);
...
router.get('/:id', verifyRolePermissions, RoleController.getRoleById);
...
router.delete('/:id',verifyRolePermissions, RoleController.deleteRoleById);
...
router.put('/:id',verifyRolePermissions,sanitizeMiddleware,validateMiddleware(updateRoleSchema), RoleController.updateRole);
