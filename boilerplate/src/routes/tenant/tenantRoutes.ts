...
router.post('/create', verifyRolePermissions,sanitizeMiddleware, validateMiddleware(createTenantSchema), TenantController.createTenant);
...
router.get('/list', verifyRolePermissions,TenantController.getTenants);
router.get('/address',verifyRolePermissions,TenantController.getAddressses)
...
router.get('/:tenantId',verifyRolePermissions, TenantController.getTenant);
...
router.patch('/status/:tenantId', verifyRolePermissions,sanitizeMiddleware, validateMiddleware(updateStatusSchema),TenantController.updateTenantStatus);
...
router.put('/:tenantId', verifyRolePermissions,sanitizeMiddleware,validateMiddleware(updateTenantSchema), TenantController.updateTenant);
