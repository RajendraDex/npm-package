...
router.post('/create',verifyRolePermissions,sanitizeMiddleware, validateMiddleware(createCustomerSchema), CustomerController.createCustomer);
/**
 * @swagger
 ...
 *                   type: null
 */
router.get('/list', verifyRolePermissions, CustomerController.getCustomers);
/**
 * @swagger
...
router.put('/:id', verifyRolePermissions,sanitizeMiddleware,validateMiddleware(updateCustomerSchema),CustomerController.updateCustomer);
...
router.patch('',verifyRolePermissions,sanitizeMiddleware, validateMiddleware( changeStatusSchema),CustomerController.updateCustomerFields)
/**
 * @swagger
 * /api/tenants/customer:
 *   delete:
...
router.delete('',verifyRolePermissions,sanitizeMiddleware, validateMiddleware(deleteCustomerSchema),CustomerController.updateCustomerFields)
...
router.get('/:id',verifyRolePermissions,CustomerController.fetchCustomer)
/**
 * @swagger
 ...
 *                   type: null
 */
router.get('/file/export-csv', verifyRolePermissions, CustomerController.exportCustomersToCSV);
 ...
 *       - bearerAuth: []
 */
router.delete('/delete-offer-link', sanitizeMiddleware,verifyRolePermissions, validateMiddleware(deleteCustomerOfferLinkSchema), CustomerController.deleteCustomerOfferLink);
