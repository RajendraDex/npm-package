 ...
 */
router.post('/create', sanitizeMiddleware,validateMiddleware(addressSchema),verifyRolePermissions,AddressController.addAddress);
 ...
 *                   type: null
 */
router.put('/:addressId',sanitizeMiddleware,validateMiddleware(updateAddressSchema),verifyRolePermissions,AddressController.updateAddress);
/**
 * @swagger
 * /api/address/list:
 *   get:
 ...
 *                   example: "Internal server error"
 */
router.get('/list', sanitizeMiddleware, verifyRolePermissions, AddressController.addressList);
 ...
 *                   type: null
 */
router.get('/:addressId',sanitizeMiddleware,verifyRolePermissions,AddressController.getAddress);
 ...
 *                   type: null
 */
router.patch('/:addressId',sanitizeMiddleware,validateMiddleware(changeStatusSchema),verifyRolePermissions,AddressController.changeStatus);
