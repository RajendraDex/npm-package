 ...
 *                   type: null
 */
router.post('/create', verifyRolePermissions as RequestHandler, sanitizeMiddleware, validateMiddleware(staffSchema) as RequestHandler, StaffController.createStaff as unknown as RequestHandler);
 ...
 *                   type: null
 */
router.get('/list', verifyRolePermissions as RequestHandler, StaffController.getStaffList as unknown as RequestHandler); // Route to get staff list
 ...
 *                   type: null
 */
router.get('/:id', verifyRolePermissions as RequestHandler, StaffController.fetchStaff as unknown as RequestHandler); // Validate ID
 ...
 *                   type: null
 */
router.put('/:id', verifyRolePermissions as RequestHandler, sanitizeMiddleware, validateMiddleware(updateStaffSchema) as RequestHandler, StaffController.updateStaff as unknown as RequestHandler);
 ...
 *                   type: null
 */
router.delete('/:id', verifyRolePermissions as RequestHandler, sanitizeMiddleware, validateMiddleware(staffDeleteSchema) as RequestHandler, StaffController.updateOrDeleteStaff as unknown as RequestHandler); // Validate ID
 ...
 *                   type: null
 */
router.patch('/:id', verifyRolePermissions as RequestHandler, sanitizeMiddleware, validateMiddleware(staffStatusSchema) as RequestHandler, StaffController.updateOrDeleteStaff as unknown as RequestHandler); // Validate ID
