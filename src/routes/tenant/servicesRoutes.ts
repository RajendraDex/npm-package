 ...
 *                   example: null
 */
router.post('/create', verifyRolePermissions as RequestHandler, sanitizeMiddleware, validateMiddleware(createServiceSchema) as RequestHandler, serviceController.createService as unknown as RequestHandler);
 ...
 *                   example: null
 */
router.put('/:id', verifyRolePermissions as RequestHandler, sanitizeMiddleware, validateMiddleware(updateServiceSchema) as RequestHandler, serviceController.updateService as unknown as RequestHandler);
 ...
 *                   example: null
 */
router.get('/', verifyRolePermissions as RequestHandler, sanitizeMiddleware, serviceController.getServices as unknown as RequestHandler);
 ...
 *                   example: null
 */
router.patch('/:id', verifyRolePermissions as RequestHandler, sanitizeMiddleware, serviceController.changeServiceStatus as unknown as RequestHandler);
 ...
 *                   example: null
 */
router.get('/:id', verifyRolePermissions as RequestHandler, sanitizeMiddleware, serviceController.getServiceById as unknown as RequestHandler);
 ...
 *                   example: null
 */
router.delete('/:id', verifyRolePermissions as RequestHandler, sanitizeMiddleware, validateMiddleware(serviceDeleteSchema) as RequestHandler, serviceController.deleteService as unknown as RequestHandler);
