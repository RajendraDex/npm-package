...
router.post('/create', verifyRolePermissions as RequestHandler, sanitizeMiddleware, validateMiddleware(createPermissionSchema) as RequestHandler, PermissionController.createPermission as unknown as RequestHandler);
 ...
 *         description: Success
 */
router.get('/list', verifyRolePermissions as RequestHandler, PermissionController.getPermissions as unknown as RequestHandler);
...
router.put('/update', verifyRolePermissions as RequestHandler, sanitizeMiddleware, validateMiddleware(updatePermissionSchema) as RequestHandler, PermissionController.updatePermission as unknown as RequestHandler);
...
router.put('/update-multiple', verifyRolePermissions as RequestHandler, sanitizeMiddleware, validateMiddleware(updateMultiplePermissionsSchema) as RequestHandler, PermissionController.updateMultiplePermissions as unknown as RequestHandler);

// Delete a permission
router.delete('/delete', verifyRolePermissions as RequestHandler, PermissionController.deletePermission as unknown as RequestHandler);

// Assign routes to a permission
router.post('/assign-routes', verifyRolePermissions as RequestHandler, PermissionController.assignRoutesToPermission as unknown as RequestHandler);
