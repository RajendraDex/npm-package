 ...
 */
router.post('/login', sanitizeMiddleware, validateMiddleware(loginSchema) as RequestHandler, UserController.login as RequestHandler);
/**
 * @swagger
 ...
 *         description: Internal Server Error
 */
router.post('/refresh-token', sanitizeMiddleware, validateMiddleware(refreshTokenSchema) as RequestHandler, UserController.refreshAccessToken as RequestHandler)
/**
 * @swagger
 ...
 *         description: Internal Server Error
 */
router.put('/changePassword', validateToken as RequestHandler, sanitizeMiddleware, validateMiddleware(changePasswordSchema) as RequestHandler, UserController.changePassword as RequestHandler);
/**
 * @swagger
 * /api/users/logout:
 *   delete:
 ...
 *         description: Internal Server Error
 */
router.delete('/logout', validateToken as RequestHandler, UserController.logout as unknown as RequestHandler);
